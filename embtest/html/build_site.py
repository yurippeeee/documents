#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""embtest/*.md -> embtest/html/NN.html (自己完結・KaTeX数式・図・章間ナビ)。"""
import os, re, html, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from figures import F as FIGS

SRC = "/home/user/documents/embtest"
OUT = "/home/user/documents/embtest/html"
os.makedirs(OUT, exist_ok=True)

CHAPTERS = [
    ("00", "00_目次と学習の進め方.md"),
    ("01", "01_ブラックボックステストとは.md"),
    ("02", "02_テスト設計の土台.md"),
    ("03", "03_電源と消費電流から状態を読む.md"),
    ("04", "04_デジタル信号の観測.md"),
    ("05", "05_UARTとシリアルコンソール.md"),
    ("06", "06_I2CとSPI.md"),
    ("07", "07_アナログ周辺とセンサ.md"),
    ("08", "08_デバッグポート経由の観測.md"),
    ("09", "09_BLEの仕組みと状況把握.md"),
    ("10", "10_BLE能動テストとファジング.md"),
    ("11", "11_WiFiとネットワーク.md"),
    ("12", "12_サブGHzとSDR.md"),
    ("13", "13_USBとその他有線.md"),
    ("14", "14_タイミングとリアルタイム性.md"),
    ("15", "15_HILハードウェアインザループ.md"),
    ("16", "16_ファジングと堅牢性.md"),
    ("17", "17_セキュリティのブラックボックス.md"),
    ("18", "18_テスト自動化ハーネスを作る.md"),
    ("19", "19_自作ツール.md"),
    ("20", "20_テスト計画とケーススタディ.md"),
]

# 章ごとのインタラクティブ部品の差し込み: 見出しに含む文字列 -> widget名 (見出し直後に挿入)
WIDGETS = {
    "01": [("観測点とオラクルを結びつける", "oracle")],
    "02": [("テストを 3 段に分解する", "decompose")],
    "03": [("電流波形から状態を読む", "current")],
    "04": [("サンプリングとデコードを体験する", "sample")],
    "05": [("シリアル線を見つけて速度を割り出す", "uart")],
    "06": [("バスの会話を読み、偽の値を返す", "i2c")],
    "07": [("電圧を掃引して校正を確かめる", "analog")],
    "08": [("止める観測と止めない観測", "debugport")],
    "09": [("BLEアドバタイズとGATTを読む", "ble_scan")],
    "10": [("GATT操作と簡易ファジング", "ble_fuzz")],
    "11": [("ポートとレイテンシを観測する", "net_probe")],
    "12": [("スペクトラムと変調を読む", "sdr_spec")],
    "13": [("USB記述子を読み解く", "usb_desc")],
    "14": [("レイテンシとジッタを可視化する", "jitter")],
    "15": [("HILループを組み立てる", "hil")],
    "16": [("入力ファジングと生存確認", "fuzz")],
    "17": [("攻撃面を洗い出す", "attack")],
    "18": [("ハーネスを設計する", "harness")],
    "19": [("自作ツールの型を選ぶ", "toolbuild")],
    "20": [("テスト計画を組み立てる", "plan")],
}
...
<title>{esc(title)} — 組み込みブラックボックステスト編</title>
