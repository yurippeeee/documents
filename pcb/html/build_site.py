#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""pcb/*.md -> pcb/html/NN.html (自己完結・KaTeX数式・図・章間ナビ)。"""
import os, re, html, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from figures import F as FIGS

SRC = "/home/user/documents/pcb"
OUT = "/home/user/documents/pcb/html"
...
CHAPTERS = [
    ...
    ("12", "12_ビア.md"),
    ("13", "13_ベタとポリゴン.md"),
    ("14", "14_電源分配とデカップリング.md"),
    ("15", "15_クロストーク.md"),
    ("16", "16_高速インタフェース.md"),
    ("17", "17_アナログと混載.md"),
    ("18", "18_熱設計.md"),
    ("19", "19_EMCのためのアートワーク.md"),
    ("20", "20_DFM.md"),
    ("21", "21_実装性と検査性.md"),
    ("22", "22_出図データ.md"),
    ("23", "23_特殊な基板とコスト.md"),
    ("24", "24_レビューとチェックリスト.md"),
]

# 章ごとのインタラクティブ部品の差し込み: 見出しに含む文字列 -> widget名 (見出し直後に挿入)
WIDGETS = {
    "01": [("回路図から製造データまでを追う", "flow")],
    "02": [("基板の断面と厚みを見る", "stack")],
    "03": [("製造公差が寸法をどう動かすか", "etch")],
    "04": [("設計ルールと製造クラスを選ぶ", "drc")],
    "05": [("層構成を組み立てる", "stackup")],
    "06": [("ランドパターンを計算する", "land")],
    "07": [("配置を動かして配線長を見る", "place")],
    "08": [("グラウンドを切ってみる", "slit")],
    "09": [("線幅と電流容量を計算する", "width")],
    "10": [("特性インピーダンスを合わせる", "imped")],
    "11": [("差動ペアとスキューを見る", "diffpair")],
    "12": [("ビアの寸法とスタブ共振", "via")],
    "13": [("サーマルランドの効きを見る", "thermal")],
    "14": [("デカップリングを置いてみる", "pdn")],
    "15": [("クロストークを見積もる", "xtalk")],
    "16": [("インタフェース別の制約を引く", "iface")],
    "17": [("アナログ部の配置を決める", "mixed")],
    "18": [("銅箔で放熱する", "heat")],
    "19": [("ループ面積と放射を見る", "loop")],
    "20": [("公差を積み上げる", "tol")],
    "21": [("リフローとステンシルを見る", "reflow")],
    "22": [("出図ファイルを確認する", "gerber")],
    "23": [("面付けとコストを計算する", "panel")],
    "24": [("アートワークレビュー用チェックリスト", "checklist")],
}
...
<title>{esc(title)} — 電磁界シミュレーション</title>
...
<body>
<header class="top">
  <a class="home" href="../../pcb.html">PCB Artwork</a>
