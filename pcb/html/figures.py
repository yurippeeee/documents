...
], "基板上の 2 点の GND の間には必ず何らかの電圧がある。デジタルなら誤差の内だが、24 bit にはフルスケールの 1/10 である")
...
F["p19_two"] = SVG(860, 320, [
    ...
    T(430, 288, "DM: ループ 1 cm² なら電流 18 mA ／ CM: ケーブル 1 m なら電流 2.4 µA", "middle", 10.5, MUT),
...
F["p19_spectrum"] = SVG(860, 300, [
    ...
    T(660, 140, "その上の放射は 12 dB 減る", "start", 10.5, ALI, True),
] + sum([[
