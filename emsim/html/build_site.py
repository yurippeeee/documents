#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""emsim/*.md -> emsim/html/NN.html (自己完結・KaTeX数式・図・章間ナビ)。"""
import os, re, html, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from figures import F as FIGS

SRC = "/home/user/documents/emsim"
OUT = "/home/user/documents/emsim/html"
os.makedirs(OUT, exist_ok=True)

CHAPTERS = [
    ("01", "01_なぜシミュレーションが必要か.md"),
    ("02", "02_マクスウェル方程式.md"),
    ("03", "03_材料と境界条件.md"),
    ("04", "04_離散化.md"),
    ("05", "05_FDTD.md"),
...
WIDGETS = {
    "01": [("手法の適用範囲を見る", "regime")],
    "02": [("マクスウェル方程式の各項を見る", "maxwell")],
    "03": [("材料と表皮深さを見る", "material")],
    "04": [("離散化の誤差を見る", "discretize")],
    "05": [("1D FDTD を走らせる", "fdtd1d")],
    "06": [("クーラン条件を破ってみる", "courant")],
    "07": [("弱形式と基底関数を見る", "fem")],
    "08": [("MoM の行列を見る", "mom")],
    "09": [("解法を選ぶ", "chooser")],
    "10": [("メッシュ密度と精度を見る", "mesh")],
    "11": [("PML の効きを見る", "pml2d")],
    "12": [("ポートと励振波形を見る", "port")],
    "13": [("メッシュ収束を確認する", "converge")],
    "14": [("S パラメータを読む", "sparam")],
    "15": [("遠方界パターンを見る", "pattern")],
    "16": [("時間波形と周波数特性を行き来する", "fft")],
    "17": [("パッチの初期寸法を計算する", "patch")],
    "18": [("TDR で不整合の場所を見つける", "tdr")],
    "19": [("シールド効果を見る", "shield")],
    "20": [("設計レビュー用チェックリスト", "checklist")],
}
...
<link rel="stylesheet" href="emsim.css">
{KATEX}
{wscript}
</head>
<body>
<header class="top">
  <a class="home" href="../../emsim.html">EM Simulation</a>
