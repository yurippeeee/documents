#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""radar/*.md -> radar/html/NN.html (自己完結・KaTeX数式・図・章間ナビ)。"""
import os, re, html, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from figures import F as FIGS

SRC = "/home/user/documents/radar"
OUT = "/home/user/documents/radar/html"
...
WIDGETS = {
    "01": [("電波の往復を見る", "echo")],
    "02": [("周波数と波長を体感する", "bands")],
    "03": [("探知距離を見積もる", "radareq")],
    "04": [("向きで変わる反射を見る", "rcs")],
    "05": [("パルス幅と PRF を調整する", "pulse")],
    "06": [("パルス圧縮を実行する", "compress")],
    "07": [("位相の回転から速度を読む", "doppler")],
    "08": [("ビート信号を観察する", "fmcw")],
    "09": [("距離-速度マップを動かす", "rdmap")],
    "10": [("位相差から角度を当てる", "aoa")],
    "11": [("アレイのビームを操る", "beam")],
    "12": [("雑音フロアと信号を比べる", "noise")],
    "13": [("CFAR のしきい値を見る", "cfar")],
    "14": [("MTI でクラッタを消す", "mti")],
    "15": [("追尾フィルタを動かす", "track")],
    "16": [("センサ構成とカバレッジ", "autoconf")],
    "17": [("呼吸を位相で見る", "vital")],
    "18": [("チャープ設計を体験する", "design")],
}
...
<body>
<header class="top">
  <a class="home" href="../../radar.html">Radar</a>
