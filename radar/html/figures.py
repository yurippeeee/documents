...
F["r03_budget"] = SVG(840, 360, [
    ...
    RECT(310, 44, 110, 210, 3, ASOFT, ALI, 1.3), T(365, 150, "−158 dB", "middle", 10.5, ALI, True),
    ...
    RECT(570, 214, 100, 24, 3, PAN, INK, 1.5), T(620, 230, "−98 dBm", "middle", 9.8, INK, True),
    T(620, 270, "受信電力", "middle", 9.5, MUT),
    W(60, 196, 800, 196, c=ALI, lw=1.6, dash="6 4"),
    T(796, 188, "雑音 −92 dBm（kTB+NF 12 dB）", "end", 9.8, ALI, True),
    DARR(720, 214, 720, 200, GRN, 1.5, 5),
    T(704, 210, "SNR −6 dB（雑音の下）", "end", 10.5, GRN, True),
...
F["r09_frame"] = SVG(840, 330, [
    ...
    '<text x="100" y="160" text-anchor="middle" font-size="10" fill="%s" font-family="var(--sans)" transform="rotate(-90 100 160)">低速時間（チャープ 1..N、刻み 数十 µs）</text>' % MUT,
...
F["r18_worked"] = SVG(860, 380, [
    ...
    for i, (t, s, c, f) in enumerate([
        ...
        ("⑥ リンクバジェット: SNR +51 dB（処理利得込み）", "電力は楽勝。SRR の本丸は分解能と曖昧さの方", SIG, SSOFT),
    ])
