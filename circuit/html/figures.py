...
def BJT(x, y, lab=None, pnp=False, mir=False, c=INK, sub=None, flip=False):
    """BJT。ベースは左（mir=True で右）。上の端子がコレクタ・下がエミッタ。
    flip=True で上下を入れ替える（PNP でエミッタを上に置くときに使う）。"""
    s = -1 if mir else 1
    f = -1 if flip else 1
    o = [W(x - s * 22, y, x - s * 9, y, c=c),
         W(x - s * 9, y - 13, x - s * 9, y + 13, c=c, lw=2.2),
         W(x - s * 9, y - f * 6, x + s * 12, y - f * 17, c=c),
         W(x + s * 12, y - f * 17, x + s * 12, y - f * 26, c=c),
         W(x - s * 9, y + f * 6, x + s * 12, y + f * 17, c=c),
         W(x + s * 12, y + f * 17, x + s * 12, y + f * 26, c=c)]
    if pnp:
        o.append(ARR(x + s * 4.5, y + f * 12.6, x - s * 6, y + f * 7, c))
    else:
        o.append(ARR(x - s * 1, y + f * 10, x + s * 10.5, y + f * 15.8, c))
    if lab: o.append(T(x + s * 20, y - 2, lab, "start" if not mir else "end", 11, MUT))
    if sub: o.append(T(x + s * 20, y + 12, sub, "start" if not mir else "end", 10, FNT))
    return "".join(o)
...
F["c02_cesr"] = SVG(600, 190, [
    ...
    O(90, 100, 5, INK), W(95, 100, 161, 100),
    RES(180, 100, "ESR", True, INK, "等価直列抵抗"),
    W(199, 100, 259, 100),
    IND(280, 100, "ESL", True, INK, "等価直列インダクタンス"),
    W(301, 100, 376, 100),
    CAP(380, 100, None, True), T(380, 82, "C", "middle", 11, MUT),
    W(384, 100, 460, 100), O(465, 100, 5, INK),
    W(95, 100, 95, 150), W(95, 150, 241, 150),
    RES(260, 150, "Rleak", True), W(279, 150, 465, 150), W(465, 150, 465, 100),
...
F["c02_lesr"] = SVG(600, 175, [
    ...
    O(110, 95, 5, INK), W(115, 95, 186, 95),
    RES(205, 95, "DCR", True, INK, "巻線の直流抵抗"),
    W(224, 95, 299, 95), IND(320, 95, "L", True), W(341, 95, 425, 95),
    O(430, 95, 5, INK),
    W(115, 95, 115, 145), W(115, 145, 266, 145),
    CAP(270, 145, None, True), T(270, 128, "Cp", "middle", 11, MUT),
    W(274, 145, 430, 145), W(430, 145, 430, 95),
...
F["c02_beadfilter"] = SVG(520, 190, [
    T(90, 76, "電源", "middle", 11.5, MUT, True), W(120, 76, 173, 76),
    FB(190, 76, "ビーズ"), W(207, 76, 280, 76), D(280, 76),
    W(280, 76, 380, 76), T(400, 80, "IC", "start", 12, INK, True),
    W(280, 76, 280, 114), CAP(280, 118, "C"), W(280, 122, 280, 145),
    GND(280, 145),
...
def _rcnet(top_lab, series, shunt, out_lab, cap_title):
    return SVG(500, 190, [
        T(70, 80, top_lab, "middle", 11.5, MUT, True), W(100, 80, 160, 80),
    ] + series + [
...
F["c03_rclp"] = _rcnet("Vin", [RES(200, 80, "R"), W(160, 80, 181, 80), W(219, 80, 300, 80)],
                       [CAP(300, 120, "C"), W(300, 124, 300, 152)],
                       "Vout", "ローパス。高周波ほどコンデンサのインピーダンスが下がり、出力が GND に落とされる")

F["c03_crhp"] = SVG(500, 190, [
    T(70, 80, "Vin", "middle", 11.5, MUT, True), W(100, 80, 182, 80),
    CAP(186, 80, "C", True), W(190, 80, 300, 80),
...
F["c03_rlc"] = SVG(560, 190, [
    ...
    RES(160, 80, "R"), W(179, 80, 239, 80),
    IND(260, 80, "L"), W(281, 80, 350, 80),
    D(350, 80), W(350, 80, 430, 80), T(442, 84, "Vout", "start", 12, SIG, True),
    W(350, 80, 350, 116), CAP(350, 120, "C"), W(350, 124, 350, 152),
    GND(350, 152),
...
F["c03_debounce"] = SVG(560, 230, [
    ...
    W(150, 126, 150, 159), SWI(150, 172, "スイッチ"), W(150, 185, 150, 198),
    GND(150, 198),
    W(240, 126, 240, 158), D(240, 126), CAP(240, 162, "C 100nF"), W(240, 166, 240, 198),
    GND(240, 198),
...
F["c04_sym"] = SVG(520, 175, [
    ...
    W(160, 80, 242, 80), DIO(250, 80, "right"), W(258, 80, 340, 80),
...
F["c04_rect"] = SVG(540, 200, [
    T(80, 80, "交流入力", "middle", 11.5, MUT, True), W(125, 80, 212, 80),
    DIO(220, 80, "right"), W(228, 80, 320, 80), D(320, 80),
    W(320, 80, 410, 80), T(424, 84, "直流出力", "start", 12, SIG, True),
    W(320, 80, 320, 116), CAP(320, 120, "C"), T(345, 134, "平滑コンデンサ", "start", 10, FNT),
    W(320, 124, 320, 152), GND(320, 152),
...
F["c04_flyback"] = SVG(540, 250, [
    ...
    W(200, 130, 330, 130), W(330, 130, 330, 66), DIO(330, 58, "up"), W(330, 50, 330, 34),
    W(330, 34, 200, 34),
    T(348, 62, "フライバックダイオード", "start", 11, SIG, True),
    T(348, 78, "（逆向きに入れる）", "start", 10, FNT),
    W(200, 130, 200, 156), NMOS(188, 178, "MOSFET"), W(200, 200, 200, 214),
    GND(200, 214),
...
F["c04_oring"] = SVG(500, 180, [
    T(80, 66, "電源 A", "middle", 11.5, MUT, True), W(125, 62, 202, 62),
    DIO(210, 62, "right"), W(218, 62, 320, 62),
    T(80, 130, "電源 B", "middle", 11.5, MUT, True), W(125, 126, 202, 126),
    DIO(210, 126, "right"), W(218, 126, 320, 126),
...
F["c04_clamp"] = SVG(500, 250, [
    RAIL(300, 34, "VDD"), W(300, 34, 300, 72),
    DIO(300, 80, "up"), W(300, 88, 300, 124),
    ...
    W(300, 124, 300, 162), DIO(300, 170, "up"), W(300, 178, 300, 206),
...
F["c04_5vin"] = SVG(560, 150, [
    T(85, 74, "信号 5 V", "middle", 11.5, MUT, True), W(140, 70, 226, 70),
    RES(245, 70, "R"), W(264, 70, 360, 70),
...
F["c05_bodydio"] = SVG(500, 230, [
    ...
    W(222, 93, 330, 93), W(330, 93, 330, 107),
    DIO(330, 115, "up"), W(330, 123, 330, 137), W(330, 137, 222, 137),
...
F["c05_gatedrv"] = SVG(520, 220, [
    T(80, 84, "MCU", "middle", 11.5, MUT, True), W(118, 80, 186, 80),
    RES(205, 80, "R_g"), W(224, 80, 300, 80), D(300, 80),
...
F["c05_pmoshs"] = SVG(440, 250, [
    RAIL(200, 34, "VCC"), W(200, 34, 200, 60),
    PMOS(188, 82, "PMOS"), W(200, 104, 200, 128),
    RECT(168, 128, 64, 44, 5, PAN, INK, 1.6), T(200, 155, "負荷", "middle", 11.5, MUT, True),
    W(200, 172, 200, 194), GND(200, 194),
    W(166, 82, 110, 82), T(100, 86, "G", "end", 12, INK, True),
...
F["c05_nmoshs"] = SVG(470, 250, [
    RAIL(200, 34, "VCC"), W(200, 34, 200, 60),
    NMOS(188, 82, "NMOS"), W(200, 104, 200, 128), D(200, 128),
    RECT(168, 128, 64, 44, 5, PAN, INK, 1.6), T(200, 155, "負荷", "middle", 11.5, MUT, True),
    W(200, 172, 200, 194), GND(200, 194),
    W(166, 82, 110, 82), T(100, 86, "G", "end", 12, INK, True),
...
F["c06_ce"] = SVG(500, 300, [
    ...
    W(230, 120, 230, 132, 242, 132, 242, 140),
...
F["c06_ef"] = SVG(470, 286, [
    RAIL(210, 34, "VCC"), W(210, 34, 210, 132, 222, 132, 222, 140),
...
F["c06_mirror"] = SVG(520, 290, [
    ...
    W(150, 96, 150, 130), D(150, 130), W(150, 130, 308, 130),
    W(150, 130, 150, 144, 162, 144, 162, 152),
    BJT(150, 178, "Q1"), W(128, 178, 128, 130), D(128, 130),
    W(162, 204, 162, 232), GND(162, 232),
    BJT(330, 178, "Q2"), W(308, 178, 308, 130),
    W(342, 204, 342, 232), GND(342, 232),
    W(342, 152, 342, 104, c=SIG, lw=1.8), ARR(342, 108, 342, 140, SIG, 1.8),
    T(354, 128, "I_out = I_ref", "start", 11.5, SIG, True),
...
F["c06_diffpair"] = SVG(560, 306, [
    ...
    W(180, 124, 203, 124), W(203, 124, 203, 144),
    W(380, 124, 357, 124), W(357, 124, 357, 144),
...
F["c07_diffin"] = SVG(540, 326, [
    ...
    W(203, 146, 203, 132), W(180, 132, 203, 132), W(337, 146, 337, 132), W(337, 132, 360, 132),
...
F["c07_ibias"] = SVG(540, 175, [
    T(80, 74, "信号源", "middle", 11.5, MUT, True), W(122, 70, 191, 70),
    RES(210, 70, "Rs = 1 MΩ"), W(229, 70, 330, 70), D(330, 70),
...
F["c07_output"] = SVG(500, 290, [
    RAIL(230, 30, "VCC"), W(230, 30, 230, 70, 242, 70, 242, 78),
    BJT(230, 104, "NPN"), W(208, 104, 150, 104),
    W(150, 104, 150, 192), D(150, 148), W(150, 148, 120, 148), T(110, 152, "前段", "end", 11, MUT),
    W(242, 130, 242, 148), D(242, 148), W(242, 148, 360, 148),
    T(372, 152, "Vout", "start", 12, SIG, True),
    W(242, 148, 242, 166),
    BJT(230, 192, "PNP", True, flip=True), W(208, 192, 150, 192),
...
F["c08_noninv"] = SVG(540, 264, [
    ...
    W(313, 100, 420, 100), D(420, 100), W(420, 100, 470, 100),
    T(482, 104, "Vout", "start", 12, SIG, True),
    W(420, 100, 420, 170), W(420, 170, 269, 170),
    RES(250, 170, "Rf"), W(231, 170, 210, 170),
...
F["c08_inv"] = SVG(540, 250, [
    OPA(300, 110, None),
    W(273, 97, 240, 97), D(240, 97), W(240, 97, 219, 97),
    RES(200, 97, "Rin"), W(181, 97, 120, 97), T(110, 101, "Vin", "end", 12, MUT, True),
    W(273, 123, 240, 123), W(240, 123, 240, 160),
    W(240, 160, 240, 172), GND(240, 172),
    W(333, 110, 440, 110), D(440, 110), W(440, 110, 490, 110),
    T(502, 114, "Vout", "start", 12, SIG, True),
    W(440, 110, 440, 52), W(440, 52, 359, 52), RES(340, 52, "Rf"), W(321, 52, 240, 52),
    W(240, 52, 240, 97),
    D(240, 97),
...
F["c08_follower"] = SVG(500, 200, [
    ...
    W(293, 95, 400, 95), D(400, 95), W(400, 95, 450, 95),
...
F["c08_diffamp"] = SVG(560, 276, [
    OPA(330, 120, None),
    W(303, 107, 262, 107), W(262, 107, 262, 96), D(262, 96), W(262, 96, 243, 96), RES(224, 96, "R1"),
    W(205, 96, 140, 96), T(130, 100, "V1", "end", 12, MUT, True),
    W(262, 96, 262, 52), W(262, 52, 371, 52), RES(390, 52, "R2"),
    W(409, 52, 448, 52), W(448, 52, 448, 120),
    W(303, 133, 250, 133), W(250, 133, 250, 152), D(250, 152), W(250, 152, 231, 152), RES(212, 152, "R1"),
    W(193, 152, 140, 152), T(130, 156, "V2", "end", 12, MUT, True),
    W(250, 152, 250, 180), RES(250, 199, "R2", False), W(250, 218, 250, 230), GND(250, 230),
    W(363, 120, 448, 120), D(448, 120), W(448, 120, 500, 120),
...
F["c08_inamp"] = SVG(680, 300, [
    ...
    T(60, 88, "V1", "middle", 12, MUT, True), W(88, 84, 120, 84), W(120, 84, 120, 72), W(120, 72, 143, 72),
    OPA(168, 84, "A1", True, 50, 48), W(199, 84, 250, 84), D(250, 84),
    T(60, 226, "V2", "middle", 12, MUT, True), W(88, 222, 120, 222), W(120, 222, 120, 234), W(120, 234, 143, 234),
    ...
    W(143, 210, 218, 210),
    W(218, 128, 281, 128), D(218, 128), RES(300, 128, "Rg"), W(319, 128, 380, 128),
    W(380, 128, 380, 178), W(380, 178, 319, 178), RES(300, 178, None), W(281, 178, 218, 178),
    D(218, 178),
...
F["c08_capload"] = SVG(500, 200, [
    ...
    W(280, 80, 280, 116), CAP(280, 120, "C_L"), W(280, 124, 280, 152), GND(280, 152),
...
F["c08_riso"] = SVG(600, 230, [
    ...
    W(200, 92, 221, 92), RES(240, 92, "R_iso"), W(259, 92, 380, 92), D(380, 92),
    W(380, 92, 470, 92), T(482, 96, "負荷", "start", 12, SIG, True),
    W(380, 92, 380, 132), CAP(380, 136, "C_L"), W(380, 140, 380, 168), GND(380, 168),
    W(200, 92, 200, 46), W(200, 46, 316, 46), CAP(320, 46, None, True),
    T(320, 30, "C_f", "middle", 11, MUT), W(324, 46, 380, 46), W(380, 46, 380, 92),
...
F["c08_cin"] = SVG(520, 250, [
    ...
    W(220, 97, 220, 150), CAP(220, 154, "C_in"), W(220, 158, 220, 186), GND(220, 186),
    T(246, 158, "入力容量（IC + 配線 + ソケット）", "start", 10, FNT),
    W(273, 123, 250, 123), W(250, 123, 250, 210), GND(250, 210),
    W(333, 110, 420, 110), D(420, 110), W(420, 110, 470, 110),
    T(482, 114, "Vout", "start", 12, SIG, True),
    W(420, 110, 420, 48), W(420, 48, 239, 48), RES(220, 48, "R_f"), W(201, 48, 220, 48),
    W(220, 48, 220, 97),
...
F["c08_halfrail"] = SVG(500, 250, [
    ...
    W(280, 120, 280, 160), D(280, 120), CAP(280, 164, "C"), W(280, 168, 280, 200), GND(280, 200),
...
F["c09_comp"] = SVG(540, 210, [
    ...
    W(283, 90, 390, 90), T(402, 94, "Vout（H / L）", "start", 12, SIG, True),
...
F["c09_hyst"] = SVG(560, 250, [
    OPA(300, 100, None),
    W(273, 87, 240, 87), D(240, 87), W(240, 87, 219, 87), RES(200, 87, "R1"), W(181, 87, 120, 87),
    T(110, 91, "Vin", "end", 12, MUT, True),
    W(273, 113, 230, 113), D(230, 113), W(230, 113, 150, 113),
    T(140, 117, "V_ref", "end", 12, MUT, True),
    W(230, 113, 230, 178), W(230, 178, 341, 178), RES(360, 178, "R2"), W(379, 178, 430, 178),
    W(430, 178, 430, 100), D(430, 100),
    W(333, 100, 430, 100), W(430, 100, 500, 100), T(512, 104, "Vout", "start", 12, SIG, True),
...
F["c09_pierce"] = SVG(560, 306, [
    ...
    W(180, 160, 281, 160), XTAL(290, 160, "水晶"), W(299, 160, 400, 160),
    D(180, 160), D(400, 160),
    W(180, 160, 180, 210), CAP(180, 214, "C1"), W(180, 218, 180, 244), GND(180, 244),
    W(400, 160, 400, 210), CAP(400, 214, "C2"), W(400, 218, 400, 244), GND(400, 244),
...
F["c09_rcosc"] = SVG(560, 262, [
    ...
    W(170, 83, 170, 150), CAP(170, 154, "C"), W(170, 158, 170, 188), GND(170, 188),
...
F["c10_brokaw"] = SVG(560, 342, [
    ...
    W(190, 132, 190, 144, 178, 144, 178, 152), BJT(190, 178, "Q1", False, True), W(212, 178, 250, 178),
    W(370, 132, 370, 144, 382, 144, 382, 152), BJT(370, 178, "Q2"), W(348, 178, 310, 178),
    W(250, 178, 310, 178),
...
F["c10_seriesshunt"] = SVG(660, 230, [
    ...
    W(280, 84, 280, 122), CAP(280, 126, "C"), W(280, 130, 280, 158), GND(280, 158),
    ...
    T(410, 88, "Vin", "middle", 11.5, MUT, True), W(440, 84, 481, 84),
    RES(500, 84, "R"), W(519, 84, 590, 84), D(590, 84),
    W(590, 84, 616, 84), T(618, 88, "V_ref", "start", 11.5, SIG, True),
    W(590, 84, 590, 116), DIO(590, 124, "up", None, INK, "z"), W(590, 132, 590, 158),
    GND(590, 158),
...
F["c10_refcap"] = SVG(540, 200, [
    ...
    W(300, 82, 300, 120), CAP(300, 124, "C"), W(300, 128, 300, 156), GND(300, 156),
...
F["c11_inv"] = SVG(480, 280, [
    RAIL(230, 34, "VDD"), W(230, 34, 230, 60),
    PMOS(218, 82, "PMOS", False, INK, "入力 L でオン"),
    W(230, 104, 230, 140), D(230, 140), W(230, 140, 330, 140),
    T(342, 144, "出力", "start", 12, SIG, True),
    W(230, 140, 230, 178), NMOS(218, 200, "NMOS", False, INK, False, "入力 H でオン"),
    W(230, 222, 230, 244), GND(230, 244),
    W(196, 82, 150, 82), W(196, 200, 150, 200), W(150, 82, 150, 200), D(150, 141),
...
F["c11_nand"] = SVG(500, 300, [
    ...
    W(150, 48, 150, 62), PMOS(138, 84, "P(A)"), W(150, 106, 150, 140),
    W(310, 48, 310, 62), PMOS(322, 84, "P(B)", True), W(310, 106, 310, 140),
    ...
    W(230, 152, 230, 178), NMOS(218, 200, "N(A)"), W(230, 222, 230, 234),
    NMOS(218, 256, "N(B)"), W(230, 278, 230, 286), GND(230, 286),
    T(292, 232, "直列", "middle", 10.5, SIG, True),
    W(116, 84, 90, 84), T(80, 88, "A", "end", 12, INK, True),
    W(344, 84, 380, 84), T(392, 88, "B", "start", 12, INK, True),
    W(196, 200, 90, 200), W(196, 256, 60, 256),
...
F["c11_nor"] = SVG(520, 320, [
    ...
    RAIL(250, 58, "VDD"), W(250, 58, 250, 72),
    PMOS(238, 94, "P(A)"), W(250, 116, 250, 128),
    PMOS(262, 150, "P(B)", True), W(250, 172, 250, 196),
    ...
    W(170, 214, 170, 228), NMOS(158, 250, "N(A)"), W(170, 272, 170, 296),
    W(330, 214, 330, 228), NMOS(342, 250, "N(B)", True), W(330, 272, 330, 296),
    W(170, 296, 330, 296), D(250, 296), W(250, 296, 250, 302), GND(250, 302),
    T(250, 226, "並列", "middle", 10.5, SIG, True),
    # A の配線（左）
    W(216, 94, 100, 94), W(100, 94, 100, 250), W(100, 250, 136, 250), D(100, 250),
    T(90, 98, "A", "end", 12, INK, True),
    # B の配線（右）
    W(284, 150, 452, 150), W(452, 150, 452, 250), W(452, 250, 364, 250), D(452, 250),
...
F["c11_aoi"] = SVG(600, 380, [
    ...
    W(200, 80, 200, 94), PMOS(188, 116, "P(A)"), W(200, 138, 200, 172),
    W(400, 80, 400, 94), PMOS(388, 116, "P(B)"), W(400, 138, 400, 172),
    W(200, 172, 400, 172), D(300, 172), T(300, 160, "A ∥ B", "middle", 10, SIG, True),
    W(300, 172, 300, 186), PMOS(288, 208, "P(C)"), W(300, 230, 300, 250),
    ...
    W(210, 266, 210, 280), NMOS(198, 302, "N(A)"), W(210, 324, 210, 332),
    NMOS(198, 354, "N(B)"), W(210, 376, 210, 378),
    # PDN 右枝：N(C)
    W(390, 266, 390, 280), NMOS(378, 302, "N(C)"), W(390, 324, 390, 366),
...
F["c11_latchup"] = SVG(620, 270, [
    ...
    BJT(230, 176, "寄生 PNP", True, True, flip=True), BJT(400, 176, "寄生 NPN"),
    # p+ → PNP エミッタ（上）、n+ → NPN エミッタ（下）
    W(146, 90, 146, 150), W(146, 150, 218, 150),
    W(472, 90, 472, 202), W(472, 202, 412, 202),
    # PNP ベース → NPN コレクタ
    W(252, 176, 300, 176), W(300, 176, 300, 150), W(300, 150, 412, 150),
    ARR(262, 176, 296, 176, ALI, 1.8),
    # PNP コレクタ → NPN ベース
    W(218, 202, 218, 214), W(218, 214, 330, 214), W(330, 214, 330, 176), W(330, 176, 378, 176),
    ARR(320, 214, 262, 214, ALI, 1.8),
    T(325, 238, "互いに正帰還を作る", "middle", 11, ALI, True),
    T(325, 254, "一度点火すると電源を切るまで止まらない", "middle", 10, FNT),
...
F["c13_sram6t"] = SVG(680, 350, [
    ...
    RAIL(240, 62, "VDD"), W(240, 62, 240, 84),
    PMOS(228, 106, "M2"), W(240, 128, 240, 158), D(240, 158),
    W(240, 158, 240, 190), NMOS(228, 212, "M1"), W(240, 234, 240, 258), GND(240, 258),
    RAIL(440, 62, "VDD"), W(440, 62, 440, 84),
    PMOS(428, 106, "M4"), W(440, 128, 440, 158), D(440, 158),
    W(440, 158, 440, 190), NMOS(428, 212, "M3"), W(440, 234, 440, 258), GND(440, 258),
    T(240, 150, "Q", "middle", 13, SIG, True), T(440, 150, "QB", "middle", 13, SIG, True),
    # たすき掛け
    W(206, 106, 196, 106), W(196, 106, 196, 212), W(196, 212, 206, 212),
    W(196, 159, 176, 159), D(196, 159),
    W(406, 106, 396, 106), W(396, 106, 396, 212), W(396, 212, 406, 212),
    ...
    # アクセストランジスタ M5 / M6
    W(240, 158, 152, 158), NMOS(140, 180, "M5"),
    W(152, 202, 152, 214), W(152, 214, 60, 214), T(52, 218, "BL", "end", 11.5, MUT, True),
    W(118, 180, 100, 180), T(90, 184, "WL", "end", 11.5, INK, True),
    W(440, 158, 528, 158), NMOS(540, 180, "M6", True),
    W(528, 202, 528, 214), W(528, 214, 620, 214), T(628, 218, "BLB", "start", 11.5, MUT, True),
    W(562, 180, 580, 180), T(590, 184, "WL", "start", 11.5, INK, True),
...
F["c13_dram"] = SVG(520, 260, [
    ...
    T(252, 62, "BL", "middle", 11.5, INK, True), W(252, 70, 252, 98),
    NMOS(240, 120, "M"),
    W(218, 120, 130, 120), T(118, 124, "WL", "end", 12, MUT, True),
    W(252, 142, 252, 176), CAP(252, 180, "C_s ≈ 25 fF"),
    W(252, 184, 252, 212), GND(252, 212),
...
F["c13_norand"] = SVG(680, 320, [
    ...
    W(170, 66, 170, 74),
] + sum([[NMOS(158, 96 + i * 56, None),
          W(136, 96 + i * 56, 90, 96 + i * 56),
          T(80, 100 + i * 56, "WL%d" % i, "end", 10.5, MUT),
          W(170, 118 + i * 56, 170, 130 + i * 56)] for i in range(3)], []) + [
    W(170, 230, 170, 274), GND(170, 274),
    ...
    T(520, 60, "BL", "middle", 11, MUT, True), W(520, 66, 520, 78),
    NMOS(508, 100, None, False, INK), W(520, 122, 520, 120),
    W(486, 100, 456, 100), T(446, 104, "選択", "end", 10, FNT),
] + sum([[NMOS(508, 142 + i * 42, None),
          W(486, 142 + i * 42, 440, 142 + i * 42),
          T(430, 146 + i * 42, "WL%d" % i, "end", 10.5, MUT),
          W(520, 164 + i * 42, 520, 162 + i * 42)] for i in range(3)], []) + [
    T(520, 254, "⋮", "middle", 14, MUT),
    W(520, 248, 520, 252), NMOS(508, 274, None, False, INK), GND(520, 296),
    W(486, 274, 456, 274), T(446, 278, "選択", "end", 10, FNT),
...
F["c14_block"] = SVG(640, 250, [
    ...
    OPA(250, 156, None, False, 54, 52),
    W(283, 156, 296, 156), W(296, 156, 296, 120), W(296, 120, 232, 120),
    ARR(232, 120, 232, 94, SIG, 1.6),
    W(400, 156, 360, 156), W(360, 156, 360, 200), W(360, 200, 206, 200),
    W(206, 200, 206, 169), W(206, 169, 223, 169),
    W(223, 143, 180, 143), T(170, 147, "V_REF", "end", 11.5, MUT, True),
    T(250, 216, "誤差アンプ", "middle", 10.5, MUT),
    RECT(40, 214, 150, 30, 6, SCR, LIN, 1.3),
    T(115, 234, "= 非反転増幅", "middle", 11, INK, True),
...
def _pass(kind, title, cap):
    ...
    if kind == "npn":
        o += [BJT(230, 80, "NPN", False, False), W(242, 54, 242, 42), W(242, 42, 176, 42),
              ...
              W(242, 106, 242, 116), W(242, 116, 308, 116), W(308, 116, 308, 80), W(308, 80, 318, 80),
              W(352, 106, 430, 106), W(430, 106, 430, 80),
              W(208, 80, 196, 80), T(202, 98, "制御", "middle", 10.5, MUT)]
        o += [T(285, 150, "V_DO ≈ 2·V_BE + V_CE(sat) ≈ 1.7 V", "middle", 11.5, ALI, True)]
    elif kind == "pnp":
        o += [BJT(280, 80, "PNP", True, flip=True), W(292, 54, 292, 42), W(292, 42, 176, 42), W(176, 42, 176, 80),
              W(292, 106, 430, 106), W(430, 106, 430, 80)]
        o += [W(258, 80, 200, 80), T(229, 96, "制御", "middle", 10.5, MUT)]
        ...
        o += [W(278, 80, 210, 80), T(244, 96, "制御", "middle", 10.5, MUT)]
...
F["c15_buck"] = SVG(640, 260, [
    ...
    W(280, 84, 319, 84), IND(340, 84, "L"), W(361, 84, 430, 84), D(430, 84),
    ...
    W(430, 84, 430, 140), CAP(430, 144, "C_OUT"), W(430, 148, 430, 196),
    W(160, 84, 160, 140), CAP(160, 144, "C_IN"), W(160, 148, 160, 196),
    W(160, 196, 430, 196), GND(320, 196),
...
F["c15_boost"] = SVG(640, 260, [
    ...
    W(145, 84, 159, 84), IND(180, 84, "L"), W(201, 84, 280, 84), D(280, 84),
    W(280, 84, 337, 84), DIO(345, 84, "right", None), W(353, 84, 430, 84), D(430, 84),
    W(430, 84, 510, 84), T(522, 88, "VOUT", "start", 12, SIG, True),
    W(280, 84, 280, 118), RECT(250, 118, 60, 36, 4, PAN, INK, 1.6),
    T(280, 141, "SW", "middle", 11, MUT, True), W(280, 154, 280, 196),
    W(430, 84, 430, 140), CAP(430, 144, "C_OUT"), W(430, 148, 430, 196),
    W(145, 84, 145, 140), CAP(145, 144, "C_IN"), W(145, 148, 145, 196),
    W(145, 196, 430, 196), GND(320, 196),
...
F["c15_hotloop"] = SVG(660, 280, [
    ...
    W(320, 128, 429, 128), IND(450, 128, "L"), W(471, 128, 540, 128),
...
F["c16_decap"] = SVG(660, 250, [
    ...
    W(150, 74, 190, 74), D(190, 74), CAP(190, 92, None),
    T(214, 78, "C", "start", 11, MUT, True),
    W(190, 74, 190, 88), W(190, 96, 190, 126), W(190, 126, 240, 126),
    ...
    W(460, 74, 600, 74), D(600, 74), CAP(600, 92, None),
    T(624, 78, "C", "start", 11, MUT, True),
    W(600, 74, 600, 88), W(600, 96, 600, 126), W(600, 126, 620, 126),
...
] + sum([[W(120 + i * 78, 60, 120 + i * 78, 102),
          CAP(120 + i * 78, 106, None),
          T(120 + i * 78, 90, ["C", "C/2", "C/4", "C/8", "…"][i], "middle", 10.5, MUT),
          W(120 + i * 78, 110, 120 + i * 78, 155),
...
F["c17_sampin"] = SVG(660, 220, [
    T(70, 84, "信号源", "middle", 11.5, MUT, True), W(114, 80, 171, 80),
    RES(190, 80, "R_source"), W(209, 80, 280, 80),
    ...
    W(420, 80, 420, 122), CAP(420, 126, "C_sample"), W(420, 130, 420, 162), GND(420, 162),
...
F["c17_prot"] = SVG(560, 190, [
    T(80, 84, "入力", "middle", 11.5, MUT, True), W(120, 80, 191, 80),
    RES(210, 80, "R = 1k"), W(229, 80, 320, 80), D(320, 80),
    W(320, 80, 410, 80), T(422, 84, "ADC ピン", "start", 11.5, INK, True),
    W(320, 80, 320, 118), CAP(320, 122, "1 nF"), W(320, 126, 320, 154), GND(320, 154),
...
F["c18_rstring"] = SVG(680, 230, [
    ...
    T(70, 74, "VREF", "middle", 11.5, MUT, True), W(108, 70, 141, 70),
] + sum([[RES(160 + i * 90, 70, None), W(179 + i * 90, 70, 231 + i * 90, 70),
          D(131 + i * 90, 70),
          W(131 + i * 90, 70, 131 + i * 90, 113),
...
F["c18_r2r"] = SVG(680, 250, [
    T(340, 26, "R-2R ラダー", "middle", 12, INK, True),
          ...
          D(150 + i * 120, 100),
          W(150 + i * 120, 173, 150 + i * 120, 203),
          SWI(150 + i * 120, 216, None, i % 2 == 0),
          T(150 + i * 120, 246, "b%d" % (3 - i), "middle", 11, INK, True)] for i in range(4)], [])
  + sum([[RES(210 + i * 120, 100, "R"), W(150 + i * 120, 100, 191 + i * 120, 100),
          W(229 + i * 120, 100, 270 + i * 120, 100)] for i in range(3)], []) + [
...
F["c18_dsdac"] = SVG(700, 200, [
    ...
    W(630, 152, 658, 152), T(662, 156, "出力", "start", 11.5, SIG, True),
    T(350, 40, "1 bit なら出力が 2 点しかない＝原理的に完全に線形", "middle", 10.5, FNT),
], "オーディオ DAC の構成。素子のマッチングに頼らずに 24 bit の線形性を得る")

F["c18_pwmrc"] = SVG(560, 200, [
    T(85, 84, "PWM 出力", "middle", 11.5, MUT, True), W(140, 80, 201, 80),
    RES(220, 80, "R"), W(239, 80, 320, 80), D(320, 80),
    W(320, 80, 410, 80), T(422, 84, "アナログ電圧", "start", 12, SIG, True),
    W(320, 80, 320, 118), CAP(320, 122, "C"), W(320, 126, 320, 154), GND(320, 154),
...
F["c19_gpio"] = SVG(660, 400, [
    ...
    RAIL(250, 88, "VDD"),
    W(250, 88, 250, 110), PMOS(238, 132, "PMOS"), W(250, 154, 250, 186), D(250, 186),
    W(250, 186, 250, 220), NMOS(238, 242, "NMOS"), W(250, 264, 250, 292), GND(250, 292),
    W(216, 132, 190, 132), W(216, 242, 190, 242), W(190, 132, 190, 242), D(190, 187),
    ...
    # ESD ダイオード
    W(430, 186, 430, 140), DIO(430, 132, "up", None, ALI), W(430, 124, 430, 96),
    RAIL(430, 96, "VDD", ALI, 22),
    T(452, 130, "D1", "start", 10.5, ALI, True),
    W(430, 186, 430, 232), DIO(430, 240, "up", None, ALI), W(430, 248, 430, 286),
...
F["c19_prot"] = SVG(560, 175, [
    T(80, 84, "外部信号", "middle", 11.5, MUT, True), W(136, 80, 201, 80),
    RES(220, 80, "R = 1k〜10k"), W(239, 80, 330, 80), D(330, 80),
...
F["c19_led"] = SVG(640, 200, [
    ...
    T(60, 88, "ピン", "middle", 11, MUT, True), W(90, 84, 131, 84),
    RES(150, 84, "R"), W(169, 84, 232, 84),
    DIO(240, 84, "right", None, INK, "led"), W(248, 84, 290, 84), GND(290, 84),
    ...
    RAIL(390, 84, "VDD", MUT, 22), W(390, 84, 432, 84),
    DIO(440, 84, "right", None, INK, "led"), W(448, 84, 501, 84),
    RES(520, 84, "R"), W(539, 84, 590, 84),
...
F["c19_lvlshift"] = SVG(600, 272, [
    ...
    NMOS(300, 156, None, False, INK, True),
    # 1.8 V 側 → ソース（下）
    W(160, 156, 220, 156), W(220, 156, 220, 190), W(220, 190, 312, 190), W(312, 190, 312, 178),
    # 3.3 V 側 → ドレイン（上）
    W(312, 134, 312, 120), W(312, 120, 380, 120), W(380, 120, 380, 156), W(380, 156, 440, 156),
    # ゲート → 1.8 V 電源
    W(278, 156, 250, 156), W(250, 156, 250, 100), T(300, 92, "ゲートは低いほうの電源（1.8 V）へ", "middle", 10, SIG, True),
    W(250, 100, 200, 100), W(200, 100, 200, 72), D(200, 72), W(200, 72, 160, 72),
    RECT(90, 208, 420, 50, 6, SCR, LIN, 1.3),
    T(300, 228, "低圧側が L → V_GS = 1.8 V でオン。高圧側が L → ボディダイオードで下がって", "middle", 10.5, MUT),
    T(300, 244, "さらにオン。どちらも駆動しなければ両側のプルアップで H", "middle", 10.5, MUT),
...
F["c20_damp"] = SVG(560, 160, [
    T(80, 84, "MCU", "middle", 11.5, MUT, True), W(122, 80, 196, 80),
    RES(215, 80, "22〜33 Ω"), W(234, 80, 400, 80),
...
F["c21_photo"] = SVG(620, 230, [
    ...
    T(70, 100, "入力", "middle", 11.5, MUT, True), W(100, 96, 161, 96),
    RES(180, 96, "R"), W(199, 96, 250, 96),
    DIO(258, 96, "right", None, INK, "led"), W(266, 96, 290, 96),
...
F["c21_hs"] = SVG(520, 300, [
    RAIL(240, 34, "V_BUS（300 V）"), W(240, 34, 240, 64),
    NMOS(228, 86, "Q1（ハイサイド）"), W(240, 108, 240, 142), D(240, 142),
    W(240, 142, 380, 142), T(392, 146, "SW ノード", "start", 11.5, SIG, True),
    T(392, 162, "0 V ↔ 300 V を往復する", "start", 10, FNT),
    W(240, 142, 240, 178), NMOS(228, 200, "Q2（ローサイド）"), W(240, 222, 240, 250),
    GND(240, 250),
    W(206, 86, 130, 86), T(120, 90, "G1", "end", 12, INK, True),
    W(206, 200, 130, 200), T(120, 204, "G2", "end", 12, INK, True),
...
F["c21_boot"] = SVG(560, 280, [
    ...
    RAIL(120, 60, "VDD"), W(120, 60, 120, 86), W(120, 86, 172, 86),
    DIO(180, 86, "right", None, INK), W(188, 86, 260, 86), D(260, 86),
    T(180, 66, "D_boot", "middle", 10.5, MUT, True),
    W(260, 86, 330, 86), T(342, 90, "VB（ハイサイド電源）", "start", 11.5, SIG, True),
    W(260, 86, 260, 126), CAP(260, 130, "C_boot"), W(260, 134, 260, 176), D(260, 176),
...
F["c21_rg"] = SVG(520, 160, [
    T(85, 84, "ドライバ", "middle", 11.5, MUT, True), W(140, 80, 206, 80),
    RES(225, 80, "R_g"), W(244, 80, 340, 80),
...
F["c21_rgsplit"] = SVG(560, 220, [
    ...
    W(180, 96, 180, 62), W(180, 62, 231, 62), RES(250, 62, "R_g(on)"),
    W(269, 62, 340, 62), W(340, 62, 340, 96),
    W(180, 96, 180, 136), W(180, 136, 224, 136),
    DIO(232, 136, "left", None, INK), W(240, 136, 297, 136),
    RES(316, 136, "R_g(off)"), W(335, 136, 340, 136), W(340, 136, 340, 96),
...
F["c22_hbridge"] = SVG(560, 320, [
    ...
    W(150, 58, 150, 80), NMOS(138, 102, "Q1"), W(150, 124, 150, 160),
    W(410, 58, 410, 80), NMOS(398, 102, "Q3"), W(410, 124, 410, 160),
    D(150, 160), D(410, 160),
    W(150, 160, 216, 160), O(240, 160, 22, INK), T(240, 165, "M", "middle", 14, MUT, True),
    W(264, 160, 410, 160),
    W(150, 160, 150, 198), NMOS(138, 220, "Q2"), W(150, 242, 150, 272),
    W(410, 160, 410, 198), NMOS(398, 220, "Q4"), W(410, 242, 410, 272),
    W(150, 272, 410, 272), GND(280, 272),
    W(116, 102, 90, 102), W(116, 220, 90, 220), W(376, 102, 470, 102), W(376, 220, 470, 220),
...
] + sum([[W(140 + i * 160, 58, 140 + i * 160, 80),
          NMOS(128 + i * 160, 102, ["U+", "V+", "W+"][i]),
          W(140 + i * 160, 124, 140 + i * 160, 158), D(140 + i * 160, 158),
          W(140 + i * 160, 158, 140 + i * 160, 194),
          NMOS(128 + i * 160, 216, ["U−", "V−", "W−"][i]),
...
F["c22_regen"] = SVG(560, 200, [
    ...
    W(320, 96, 320, 112), W(320, 120, 320, 156), GND(320, 156),
...
F["c23_stackup"] = SVG(620, 260, [
    ...
    ARR(520, 62, 520, 96, SIG, 1.5), T(526, 76, "L1 のリターンは L2", "start", 9, SIG),
    ARR(520, 196, 520, 168, ALI, 1.5), T(526, 186, "L4 のリターンは L3", "start", 9, ALI),
...
F["c23_branch"] = SVG(660, 250, [
    ...
    T(50, 86, "送信", "middle", 11, MUT, True), W(78, 82, 116, 82),
    RES(135, 82, "R"), W(154, 82, 220, 82), D(220, 82),
    ...
    W(452, 82, 470, 60), W(470, 60, 481, 60), RES(500, 60, "R"), W(519, 60, 580, 60),
    T(592, 64, "受信 A", "start", 10.5, MUT),
    W(452, 82, 470, 104), W(470, 104, 481, 104), RES(500, 104, "R"), W(519, 104, 580, 104),
...
F["c24_cmc"] = SVG(560, 240, [
    ...
    W(100, 90, 199, 90), IND(220, 90, None), W(241, 90, 460, 90),
    W(100, 150, 199, 150), IND(220, 150, None), W(241, 150, 460, 150),
...
F["c25_probe"] = SVG(620, 200, [
    ...
    W(140, 80, 161, 80), RES(180, 80, "9 MΩ"), W(199, 80, 300, 80), D(300, 80),
    W(300, 80, 400, 80),
    RECT(400, 56, 150, 48, 6, PAN, LIN, 1.5),
    T(475, 78, "オシロ", "middle", 11, MUT, True), T(475, 94, "1 MΩ ∥ 15 pF", "middle", 9.5, FNT),
    W(140, 80, 140, 126), CAP(140, 130, "≈10 pF"), W(140, 134, 140, 162), GND(140, 162),
    W(300, 80, 300, 126), CAP(300, 130, "補正 C"), W(300, 134, 300, 162), GND(300, 162),
...
F["c13_eeprom"] = SVG(520, 270, [
    T(260, 26, "EEPROM の 2T セル", "middle", 12, INK, True),
    T(192, 50, "BL", "middle", 11.5, INK, True), W(192, 58, 192, 78),
    NMOS(180, 100, "選択 Tr"), W(158, 100, 100, 100), T(90, 104, "WL", "end", 11.5, INK, True),
    W(192, 122, 192, 140),
    NMOS(180, 162, "セル Tr（FG）"), W(158, 162, 100, 162), T(90, 166, "CG", "end", 11.5, INK, True),
    W(192, 184, 192, 204), GND(192, 204),
    RECT(60, 218, 400, 44, 6, SCR, LIN, 1.3),
    T(260, 236, "バイトごとに選択トランジスタを持つので、バイト単位で消去できる", "middle", 10.5, MUT),
    T(260, 252, "その代わり面積は Flash の 2〜3 倍", "middle", 10.5, MUT, True),
], "原理は Flash と同じフローティングゲート。違いは「バイトごとに選択できるか」だけ")

F["c13_fram"] = SVG(500, 250, [
    T(250, 26, "FRAM（強誘電体メモリ）のセル", "middle", 12, INK, True),
    T(250, 60, "プレート線", "middle", 11.5, INK, True), W(250, 68, 250, 102),
    ...
    W(306, 176, 340, 176), T(350, 180, "WL", "start", 11.5, INK, True),
    W(272, 198, 272, 214), W(272, 214, 150, 214), T(138, 218, "BL", "end", 12, MUT, True),
