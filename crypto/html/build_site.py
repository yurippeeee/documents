...
SRC = "/home/user/documents/crypto"
OUT = "/home/user/documents/crypto/html"
os.makedirs(OUT, exist_ok=True)

CHAPTERS = [
    ("01", "01_合同算術とユークリッドの互除法.md"),
    ("02", "02_群・環・体.md"),
    ("03", "03_有限体GFp.md"),
    ("04", "04_多項式と既約多項式.md"),
    ("05", "05_拡大体GF2m.md"),
    ...
    ("10", "10_BCH符号.md"),
    ("11", "11_リードソロモン符号.md"),
    ("12", "12_暗号の基礎概念と古典暗号.md"),
    ("13", "13_ストリーム暗号とLFSR.md"),
    ("14", "14_ブロック暗号とAES.md"),
    ("15", "15_数論の道具.md"),
    ("16", "16_RSA.md"),
    ("17", "17_DHと楕円曲線暗号.md"),
    ("18", "18_ハッシュ・MAC・デジタル署名.md"),
]

# 章ごとのインタラクティブ部品の差し込み: 見出しに含む文字列 -> widget名 (見出し直後に挿入)
WIDGETS = {
    "01": [("ユークリッドの互除法", "euclid"), ("繰り返し二乗法", "powmod")],
    "02": [("ラグランジュの定理とその帰結", "grouptable")],
...
<body>
<header class="top">
  <a class="home" href="../../crypto.html">暗号と符号</a>
