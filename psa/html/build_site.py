...
SRC = "/home/user/documents/psa"
OUT = "/home/user/documents/psa/html"
...
CHAPTERS = [
    ...
    ("13", "13_セキュアストレージ.md"),
    ("14", "14_アテステーション.md"),
    ("15", "15_MbedTLSでの実装.md"),
    ("16", "16_TF-Mでの実装.md"),
    ("17", "17_実践パターン.md"),
    ("18", "18_落とし穴とチェックリスト.md"),
]

# 章ごとのインタラクティブ部品の差し込み: 見出しに含む文字列 -> widget名 (見出し直後に挿入)
WIDGETS = {
    "01": [("仕様と実装の地図を歩く", "map")],
    "02": [("エラーコードを読み解く", "status")],
    "03": [("属性を組み立てる", "attr")],
    "04": [("鍵の一生を追う", "lifecycle")],
    "05": [("ハッシュの性質を確かめる", "hash")],
    "06": [("HMAC を実際に計算する", "mac")],
    "07": [("モードと IV を確かめる", "cipher")],
    "08": [("AEAD の 4 つの入力を触る", "aead")],
    "09": [("署名の流れとサイズを見る", "sign")],
    "10": [("HKDF の入力を変えて出力を見る", "kdf")],
    "11": [("鍵合意で同じ秘密ができるのを見る", "ecdh")],
    "12": [("ライフタイムと鍵 ID を組み立てる", "lifetime")],
    "13": [("ITS を操作する", "its")],
    "14": [("トークンの構造を見る", "attest")],
    "15": [("設定を組み立てる", "config")],
    "16": [("壁越しの呼び出しを追う", "tfm")],
    "17": [("要件から呼び出し列を組み立てる", "pattern")],
    "18": [("レビュー用チェックリスト", "checklist")],
}
...
<title>{esc(title)} — PSA API 実装入門</title>
...
<body>
<header class="top">
  <a class="home" href="../../psa.html">PSA APIs</a>
