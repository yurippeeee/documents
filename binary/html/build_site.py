#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""binary/*.md -> binary/html/NN.html (自己完結・KaTeX数式・図・章間ナビ)。"""
import os, re, html, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from figures import F as FIGS

SRC = "/home/user/documents/binary"
OUT = "/home/user/documents/binary/html"
...
CHAPTERS = [
    ...
    ("05", "05_ELFファイル.md"),
    ("06", "06_HEXとSREC.md"),
    ("07", "07_CortexMのイメージ.md"),
    ("08", "08_ブートローダとイメージ形式.md"),
    ("09", "09_ファイルシステム.md"),
    ("10", "10_NVM3.md"),
    ("11", "11_NVS系ストレージ.md"),
    ("12", "12_ログとリングバッファ.md"),
...
WIDGETS = {
    "01": [("解析の手順を追う", "workflow")],
    "02": [("作業から道具とコマンドを引く", "tools")],
    "03": [("バイト列を各型として解釈する", "interp")],
    "04": [("経路を選ぶ", "acquire")],
    "05": [("ELF の構造を組み立てる", "elf")],
    "06": [("HEX の 1 行を解剖する", "hex")],
    "07": [("ベクタテーブルを読む", "vectors")],
    "08": [("MCUboot イメージを解剖する", "mcuboot")],
    "09": [("ファイルシステムを見分ける", "fs")],
    "10": [("追記型ストレージから最新値を復元する", "nvm3")],
    "11": [("3 つのストアを同じ型で読む", "kvstore")],
    "12": [("リングバッファを時系列に戻す", "ring")],
    "13": [("ダンプから秘密を捜索する", "secrets")],
    "14": [("エントロピーで領域を塗り分ける", "entropy")],
    "15": [("Linux イメージを層に分ける", "linux")],
    "16": [("逆アセンブルのとっかかりを選ぶ", "disasm")],
    "17": [("動的解析の手段を選ぶ", "dynamic")],
    "18": [("差分から意味を読む", "diff")],
    "19": [("構造から道具を選ぶ", "parser")],
    "20": [("4 つのケースを通しで追う", "cases")],
}
...
<body>
<header class="top">
  <a class="home" href="../../binary.html">Binary Analysis</a>
