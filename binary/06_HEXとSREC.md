...
> メモリマップ（[01 章 §3](01_バイナリ解析とは何か.md#ワークフロー-ダンプを手にしてからの-5-手順)）、オフセット（[03 章 §1](03_バイト列を読む基本.md#16-進ダンプの読み方)）、チェックサム（[03 章 §8](03_バイト列を読む基本.md#チェックサムと-crc-を見分ける)）、ブートローダ（[04 章 §5](04_ダンプを手に入れる.md#ブートローダ-isp-経由)）
