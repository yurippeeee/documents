...
> Matter（[01 章 3 節](01_Matterとは何か.md#matter-は何であって-何でないか)）、コミッショニング（[01 章 3 節](01_Matterとは何か.md#matter-は何であって-何でないか)）、セキュリティ（[01 章 2 節](01_Matterとは何か.md#matter-の設計目標)）、ネットワーク（[01 章 3 節](01_Matterとは何か.md#matter-は何であって-何でないか)）、IPv6（[02 章 1 節](02_アーキテクチャと用語.md#レイヤ構造)）、データモデル（[02 章 1 節](02_アーキテクチャと用語.md#レイヤ構造)）、トランスポート（[02 章 1 節](02_アーキテクチャと用語.md#レイヤ構造)）、リンク（[02 章 1 節](02_アーキテクチャと用語.md#レイヤ構造)）、mDNS（[03 章 4 節](03_IPv6の基礎.md#マルチキャスト-探索の要)）、マルチキャスト（[03 章 3 節](03_IPv6の基礎.md#アドレスの種類-ここを取り違えると詰まる)）、Router（[04 章 2 節](04_Thread.md#ノードの役割)）
...
| 項目 | 内容 |
|---|---|
| **IPv6 必須** | ルータが IPv6 を有効にしている必要がある（[03 章](03_IPv6の基礎.md#なぜ-ipv6-なのか)） |
| mDNS | マルチキャストが通ること |
...
> **製品では必ず個体ごとに変えること**（[13 章](13_コミッショニング.md)・[22 章](22_認証と製品化.md)）。
...
> ただし**再コミッショニング用に、条件付きで再開できる**必要はある（[14 章](14_運用時のセキュリティ.md)）。
