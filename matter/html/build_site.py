...
SRC = "/home/user/documents/matter"
OUT = "/home/user/documents/matter/html"
...
CHAPTERS = [
    ...
    ("06", "06_探索とメッセージング.md"),
    ("07", "07_データモデルの構造.md"),
    ("08", "08_クラスタとデバイスタイプ.md"),
    ("09", "09_インタラクションモデル.md"),
    ("10", "10_サブスクリプション.md"),
    ("11", "11_セキュリティの全体像.md"),
    ("12", "12_デバイス認証と証明書.md"),
    ("13", "13_コミッショニング.md"),
...
WIDGETS = {
    "01": [("組み合わせ爆発", "ecosystem")],
    "02": [("レイヤ構造", "stack"), ("1 つの操作を最後まで追う", "trace")],
    "03": [("アドレスの種類", "ipv6"), ("マルチキャスト", "mcast")],
    "04": [("ノードの役割", "thread"), ("Sleepy End Device", "sedpower")],
    "05": [("ネットワークの選び方", "netchoice")],
    "06": [("DNS-SD による探索", "dnssd"), ("MRP — メッセージ信頼性プロトコル", "mrp")],
    "07": [("階層をもう一度", "tree"), ("Attribute（属性）", "featuremap")],
    "08": [("汎用アプリケーションクラスタ", "clusters"), ("主なデバイスタイプ", "devtype")],
    "09": [("ワイルドカードの展開", "path"), ("ステータスコード", "status")],
    "10": [("サブスクリプションの仕組み", "subscribe")],
    "11": [("使われている暗号プリミティブ", "crypto")],
    "12": [("検証のフロー", "certchain")],
    "13": [("オンボーディングペイロード", "qrcode"), ("手動ペアリングコード", "manualcode"), ("全体の流れ", "commission")],
    "14": [("ACL — アクセス制御リスト", "acl"), ("マルチアドミン", "fabric")],
    "15": [("chip-tool — 最重要のツール", "chiptool")],
    "16": [("属性の格納方式", "zap")],
    "17": [("TLV — Matter のシリアライズ形式", "tlv"), ("電池寿命の見積り", "battery")],
    "18": [("Requestor 側の流れ", "ota")],
    "19": [("Endpoint の構成", "bridge")],
    "20": [("3 つの道", "ctrlpath")],
    "21": [("切り分けの基本方針", "triage")],
    "22": [("認証プロセスの全体像", "certflow")],
    "23": [("分野別の落とし穴", "checklist")],
    "24": [("バージョンの歩み", "timeline")],
}
...
<body>
<header class="top">
  <a class="home" href="../../matter.html">Matter</a>
