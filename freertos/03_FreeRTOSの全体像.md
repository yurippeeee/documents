...
> コンテキスト（[01 章 6 節](01_OSがない世界.md#os-が与える-1-つの発明)）、TCB（[02 章 2 節](02_タスクという抽象.md#タスクとは何か)）、スタック（[02 章 2 節](02_タスクという抽象.md#タスクとは何か)）、タスク（[02 章 2 節](02_タスクという抽象.md#タスクとは何か)）
...
**あってもなくても動く**（性能が変わるだけ）。詳しくは [07 章](07_Readyリストの実装.md)。
...
[04 章](04_タスクの状態機械.md)から [10 章](10_ブロックと遅延リスト.md)までは、ずっとこの話をする。
...
> `configTOTAL_HEAP_SIZE` を増やすか、静的確保に切り替える（[16 章](16_メモリ管理.md)）。
