...
SRC = "/home/user/documents/freertos"
OUT = "/home/user/documents/freertos/html"
os.makedirs(OUT, exist_ok=True)

CHAPTERS = [
    ("01", "01_OSがない世界.md"),
    ("02", "02_タスクという抽象.md"),
    ("03", "03_FreeRTOSの全体像.md"),
    ("04", "04_タスクの状態機械.md"),
    ("05", "05_TCBとコンテキストスイッチ.md"),
    ("06", "06_スケジューリング方針.md"),
    ("07", "07_Readyリストの実装.md"),
    ("08", "08_ティックとタイムスライス.md"),
    ("09", "09_アイドルタスクとフック.md"),
    ("10", "10_ブロックと遅延リスト.md"),
    ("11", "11_キュー.md"),
    ("12", "12_セマフォとミューテックス.md"),
    ("13", "13_優先度逆転と優先度継承.md"),
    ("14", "14_タスク通知とイベントグループ.md"),
    ("15", "15_ソフトウェアタイマ.md"),
    ("16", "16_メモリ管理.md"),
    ("17", "17_スタックとオーバーフロー.md"),
    ("18", "18_割り込みとの境界.md"),
    ("19", "19_排他制御の設計.md"),
    ("20", "20_リアルタイム性の解析.md"),
    ("21", "21_デバッグとトレース.md"),
    ("22", "22_設計指針と他のOSとの比較.md"),
]

# 章ごとのインタラクティブ部品の差し込み: 見出しに含む文字列 -> widget名 (見出し直後に挿入)
WIDGETS = {
    "01": [("スーパーループの応答時間", "superloop")],
    "02": [("並行と並列の見え方", "concurrency"), ("タスク分割の効果", "tasksplit")],
    "03": [("カーネル全体の地図", "kernelmap")],
    "04": [("状態機械を動かす", "taskstate")],
    "05": [("コンテキストスイッチをステップ実行する", "ctxswitch"), ("切り替えコストの影響", "swcost")],
    "06": [("スケジューリングのガントチャート", "sched")],
    "07": [("リストの操作", "listops"), ("Ready リストの動作", "readylist")],
    "08": [("ティックとタイムスライスを見る", "tick")],
    "09": [("CPU 使用率を測る", "cpuload")],
    "10": [("遅延リストの動作", "delaylist")],
    "11": [("キューの動作", "queue")],
    "12": [("セマフォ／ミューテックスの動作比較", "semaphore")],
    "13": [("優先度逆転を見る", "priinv")],
    "14": [("タスク通知 vs キューのコスト", "notifycost")],
    "15": [("ソフトウェアタイマの動作を見る", "swtimer")],
    "16": [("ヒープの動作を見る", "heap")],
    "17": [("スタック使用量を見る", "stack")],
    "18": [("割り込みレイテンシを見る", "isrlatency")],
    "19": [("デッドロックを見る", "deadlock")],
    "20": [("利用率境界を確かめる", "rmbound"), ("応答時間解析を実行する", "rta")],
    "21": [("実行時間統計を見る", "runtimestats")],
    "22": [("設計レビュー用チェックリスト", "checklist")],
}
...
<title>{esc(title)} — FreeRTOS</title>
<link rel="stylesheet" href="rtos.css">
{KATEX}
{wscript}
</head>
<body>
<header class="top">
  <a class="home" href="../../freertos.html">FreeRTOS</a>
